...
# Во сколько раз цена ордера может отличаться от опорной, оставаясь рыночной.
# Жёсткий порог: что вне коридора — выбрасывается из книги (ESI §5.4).
# ВНИМАНИЕ: значение умозрительное, подлежит проверке на реальных данных
# (ROADMAP, этап 11.3). До проверки фильтр не включать.
HISTORY_BAND_FACTOR = 4.0
